    ...
    <footer className="bg-gradient-to-r from-red-400 to-red-800 text-white py-10">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="text-center sm:text-left">
          ...
          <p>Email: <a href="mailto:augustine@example.com" className="hover:text-blue-200 transition duration-300">augustine@example.com</a></p>
          <p>Phone: <span className="hover:text-blue-200 transition duration-300">+263 786 831 708</span></p>
        </div>

        <div className="text-center">
          <h4 className="text-2xl font-bold mb-2 underline">Follow Me</h4>
          <div className="flex justify-center space-x-6">
            <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:scale-110 transition-transform duration-300">
            ...
            <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:scale-110 transition-transform duration-300">
            ...
            <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:scale-110 transition-transform duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 h-8" viewBox="0 0 24 24">
